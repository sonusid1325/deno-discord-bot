...
Object.defineProperty(exports, "createOAuth2Link", {
    enumerable: true,
    get: function() {
        return createOAuth2Link;
    }
});
const _permissions = require("./permissions.cjs");
function createOAuth2Link(options) {
    ...
    if (options.permissions) url += `&permissions=${Array.isArray(options.permissions) ? (0, _permissions.calculateBits)(options.permissions) : options.permissions}`;
