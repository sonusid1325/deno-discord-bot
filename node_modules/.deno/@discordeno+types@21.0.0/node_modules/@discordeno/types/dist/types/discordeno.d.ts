import type { AutoModerationActionType, AutoModerationEventTypes, AutoModerationTriggerTypes, DiscordApplicationCommandOption, DiscordApplicationCommandOptionChoice, DiscordApplicationEventWebhookStatus, DiscordApplicationIntegrationType, DiscordAttachment, DiscordAutoModerationRuleTriggerMetadataPresets, DiscordChannel, DiscordDefaultReactionEmoji, DiscordEmbed, DiscordForumTag, DiscordGuildOnboardingMode, DiscordGuildOnboardingPrompt, DiscordInstallParams, DiscordInteractionContextType, DiscordInteractionEntryPointCommandHandlerType, DiscordMessageReferenceType, DiscordPollAnswer, DiscordPollLayoutType, DiscordPollMedia, DiscordReactionType, DiscordRole, DiscordScheduledEventRecurrenceRule, DiscordWebhookEventType } from './discord.js';
import type { AllowedMentionsTypes, ApplicationCommandTypes, ApplicationFlags, AuditLogEvents, BigString, ButtonStyles, Camelize, ChannelTypes, DefaultMessageNotificationLevels, ExplicitContentFilterLevels, ForumLayout, GuildFeatures, InteractionResponseTypes, Localization, MessageComponentTypes, MessageFlags, OverwriteTypes, PermissionStrings, ScheduledEventEntityType, ScheduledEventPrivacyLevel, ScheduledEventStatus, SortOrderTypes, SystemChannelFlags, TargetTypes, TextStyles, VerificationLevels, VideoQualityModes } from './shared.js';
...
export type MessageComponent = ActionRow | ButtonComponent | InputTextComponent | SelectMenuComponent | SelectMenuChannelsComponent | SelectMenuRolesComponent | SelectMenuUsersComponent | SelectMenuUsersAndRolesComponent;
/** https://discord.com/developers/docs/interactions/message-components#actionrow */
export interface ActionRow {
    /** Action rows are a group of buttons. */
    type: MessageComponentTypes.ActionRow;
    /** The components in this row */
    components: [Exclude<MessageComponent, ActionRow>] | [ButtonComponent, ButtonComponent] | [ButtonComponent, ButtonComponent, ButtonComponent] | [ButtonComponent, ButtonComponent, ButtonComponent, ButtonComponent] | [ButtonComponent, ButtonComponent, ButtonComponent, ButtonComponent, ButtonComponent];
}
...
//# sourceMappingURL=discordeno.d.ts.map