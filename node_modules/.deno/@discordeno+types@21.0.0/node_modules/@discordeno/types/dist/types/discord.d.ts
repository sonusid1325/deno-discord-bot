import type { ActivityTypes, AllowedMentionsTypes, ApplicationCommandOptionTypes, ApplicationCommandPermissionTypes, ApplicationCommandTypes, ApplicationFlags, AttachmentFlags, AuditLogEvents, ButtonStyles, ChannelFlags, ChannelTypes, DefaultMessageNotificationLevels, EmbedTypes, ExplicitContentFilterLevels, ForumLayout, GatewayEventNames, GuildFeatures, GuildNsfwLevel, IntegrationExpireBehaviors, InteractionResponseTypes, InteractionTypes, Localization, MessageActivityTypes, MessageComponentTypes, MessageFlags, MessageTypes, MfaLevels, OverwriteTypes, PickPartial, PremiumTiers, PremiumTypes, RoleFlags, ScheduledEventEntityType, ScheduledEventPrivacyLevel, ScheduledEventStatus, SkuFlags, SortOrderTypes, StickerFormatTypes, StickerTypes, SystemChannelFlags, TargetTypes, TeamMembershipStates, TextStyles, VerificationLevels, VideoQualityModes, WebhookTypes } from './shared.js';
...
export interface DiscordSelectMenuComponent {
    type: MessageComponentTypes.SelectMenu | MessageComponentTypes.SelectMenuChannels | MessageComponentTypes.SelectMenuRoles | MessageComponentTypes.SelectMenuUsers | MessageComponentTypes.SelectMenuUsersAndRoles;
