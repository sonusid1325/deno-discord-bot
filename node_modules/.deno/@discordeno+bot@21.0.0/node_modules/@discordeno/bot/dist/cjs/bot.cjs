...
Object.defineProperty(exports, "createBot", {
    enumerable: true,
    get: function() {
        return createBot;
    }
});
const _gateway = require("@discordeno/gateway");
const _rest = require("@discordeno/rest");
const _utils = require("@discordeno/utils");
const _handlers = require("./handlers.cjs");
const _helpers = require("./helpers.cjs");
const _transformers = require("./transformers.cjs");
function createBot(options) {
    ...
    const id = (0, _utils.getBotIdFromToken)(options.token);
    const bot = {
        id,
        applicationId: id,
        transformers: (0, _transformers.createTransformers)(options.transformers),
        handlers: (0, _handlers.createBotGatewayHandlers)(options.handlers ?? {}),
        rest: (0, _rest.createRestManager)(options.rest),
        gateway: (0, _gateway.createGatewayManager)(options.gateway),
        events: options.events ?? {},
        logger: options.loggerFactory ? options.loggerFactory('BOT') : (0, _utils.createLogger)({
            name: 'BOT'
        }),
