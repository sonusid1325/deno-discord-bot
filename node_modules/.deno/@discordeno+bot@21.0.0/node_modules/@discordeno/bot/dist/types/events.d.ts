...
export type EventHandlers<TProps extends TransformersDesiredProperties, TBehavior extends DesiredPropertiesBehavior> = {
    ...
    guildStickersUpdate: (payload: {
        guildId: bigint;
        stickers: SetupDesiredProps<Sticker, TProps, TBehavior>[];
    }) => unknown;
    ...
    messageDelete: (payload: {
        ...
        channelId: bigint;
        guildId?: bigint;
    }, message?: SetupDesiredProps<Message, TProps, TBehavior>) => unknown;
    ...
    soundboardSoundsUpdate: (payload: {
        soundboardSounds: SetupDesiredProps<SoundboardSound, TProps, TBehavior>[];
        guildId: bigint;
    }) => unknown;
